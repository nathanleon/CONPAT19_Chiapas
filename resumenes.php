...
<body>
  ...
  <section class="contenido">
    <div class="content-initial">
      <div class="contenido-2__tittle">
        ...
        <div class="contenido-2__p">
          <p>
            GRACIAS por participar, adjunte su resumen antes del 30 de Diciembre 2018. Si no pudiste cargar a tiempo tu resumen y/o trabajo en extenso, <span class="bolder-text">Hazlo ahora!!</span> <br><br>Descargue el formato de resumen y la guía de apoyo para su envío <a class="bolder-text" href="http://alconpat.org/conpat2019/assets/files/Formato%20de%20resumen%20y%20guia%20de%20env%C3%ADo,%20conpat2019.pdf" title="" target="_blank">aquí.</a><br>
          </p>
    ...
    Si ya tiene una cuenta, acceda <a class="bolder-text" href="http://congresoconpat.org/index.php/congresosconpat/conpat2019/login" title="" target="_blank">aquí.</a><br>
              ...
              <p>Para cualquier duda o aclaración favor de comunicarse a: <a class="bolder-text" href="mailto:conpat2019@gmail.com">contacto@conpat2019.com</a> o al (961) 61-5-03-22 ext 114.</p>
          <p class="center-text">
