  ...
  <section class="contenido">
    <div class="content-initial">
      ...
      <div class="content-initial__p">
        <div>
        <iframe src="https://docs.google.com/forms/d/e/1FAIpQLScsF7i7bDjkwcAWYAV33yppMyva659pHfjvjMmWoJBmu2-SeA/viewform?embedded=true" width="600" height="1000" frameborder="0" marginheight="0" marginwidth="0">Cargando�</iframe>
        </div>
      </div>
      <!-- <div class="content-initial__p">
        <p class="center-text">
